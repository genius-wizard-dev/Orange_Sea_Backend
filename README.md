...
- Base URLs: [api-orange-sea.nonegroup.io.vn](https://api-orange-sea.nonegroup.io.vn/)
- Swagger: [Tài liệu API](https://api-orange-sea.nonegroup.io.vn/swagger)
- JSON Swagger: [Tài liệu JSON](https://api-orange-sea.nonegroup.io.vn/swagger-json)
...
| Name        | Type                                      | Required | Restrictions | Title | description                      |
| ----------- | ----------------------------------------- | -------- | ------------ | ----- | -------------------------------- |
| _anonymous_ | [[FriendResponse](#schemafriendresponse)] | false    | none         |       | none                             |
...
| Name        | Type                                                    | Required | Restrictions | Title | description                                    |
| ----------- | ------------------------------------------------------- | -------- | ------------ | ----- | ---------------------------------------------- |
| _anonymous_ | [[UserSearchResponseDto](#schemausersearchresponsedto)] | false    | none         |       | none                                           |
